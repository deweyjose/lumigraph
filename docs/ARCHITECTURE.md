...
- Vercel connects **directly to the RDS instance** (publicly accessible, IAM auth + TLS enforced). RDS Proxy has been removed; Single-AZ and 20 GB storage caps keep the instance within AWS free-tier limits where applicable.
